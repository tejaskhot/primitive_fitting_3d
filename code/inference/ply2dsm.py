...
bldg_prim_dir = '/usr0/home/tkhot/Downloads/results/results/jacksonville_d4/buildings_prim'
bridge_prim_dir = '/usr0/home/tkhot/Downloads/results/results/jacksonville_d4/bridge_prim'
...
for aoi_name in ['wpafb_d1', 'wpafb_d2','ucsd_d3', 'jacksonville_d4']:
    ...
    aoi_ply_file = os.path.join('../../outputs/{}/ply_primitives'.format(aoi_name),'aoi.ply')
    # scores_dir = os.path.join(bldg_fit_dir, 'scores')
    # os.makedirs(scores_dir, exist_ok=True)

    true_ortho_file = os.path.join('../../scoring/data/outputs/{}/buildings_dsm'.format(aoi_name), 'true_ortho.tif')
    ...
    textured_ply_file = os.path.join('../../outputs/{}/ply_primitives'.format(aoi_name),'aoi_textured.ply')
