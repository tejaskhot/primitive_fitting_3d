...
parser.add_argument('--var_count', default=True, type=lambda x: (str(x).lower() == 'true'), help='use variable count prediction')
parser.add_argument('--cuda', default=True, type=lambda x: (str(x).lower() == 'true'), help='use cuda')
parser.add_argument('--save_gif', default=False, type=lambda x: (str(x).lower() == 'true'), help='save a gif')
parser.add_argument('--save_plot', default=False, type=lambda x: (str(x).lower() == 'true'), help='save matplotlib plots')

parser.add_argument('--aoi', type=str, default = '',  help='aoi name')
parser.add_argument('--syn_path', type=str, default = '../../data/synthetic/',  help='data path')
parser.add_argument('--params_path', type=str, default = '../../data/params_synthetic.npy',  help='params path')
parser.add_argument('--file_path', type=str, default = '../../data/real/',  help='data path')
parser.add_argument('--save_path', type=str, default = '../../outputs/',  help='save path')

parser.add_argument('--model', type=str, default = '../../saved_models/norot_rnn5.pth',  help='trained model path')
